...
internal static class Constants
{
    ...
    public const string SteamInputInterfaceVersion = "SteamInput006";
    public const string SteamInventoryInterfaceVersion = "STEAMINVENTORY_INTERFACE_V003";
    public const string SteamMatchmakingServersInterfaceVersion = "SteamMatchMakingServers002";
    public const string SteamMatchmakingInterfaceVersion = "SteamMatchMaking009";
    public const string SteamMusicRemoteInterfaceVersion = "STEAMMUSICREMOTE_INTERFACE_VERSION001";
    public const string SteamMusicInterfaceVersion = "STEAMMUSIC_INTERFACE_VERSION001";
    public const string SteamNetworkingMessagesInterfaceVersion = "SteamNetworkingMessages002";
